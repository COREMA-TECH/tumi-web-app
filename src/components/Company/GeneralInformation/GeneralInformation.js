                            ...
                            <div class="card-body">
                                <div className="row">
                                    ...
                                    <div className="col-md-6 col-lg-3">
                                        ...
                                        <InputForm type="number" value={this.state.rate} change={(text) => {
                                            this.updateInput(text, 'rate');
                                        }} error={!this.state.rateValid} maxLength="10"
                                                   disabled={!this.props.showStepper}/>
                                    </div>
                                    <div className="col-md-6 col-lg-3">
                                        <label className="">* Company Code</label>
                                        <InputForm value={this.state.Code} change={(text) => {
                                            this.updateInput(text, 'Code');
                                        }} error={!this.state.codeValid} maxLength="10"
                                                   disabled={!this.props.showStepper}/>
                                    </div>
                                    <div className="col-md-6 col-lg-4">
                                        <label>* Company Name</label>
                                        <InputForm value={this.state.name} change={(text) => {
                                            this.updateInput(text, 'name');
                                        }} error={!this.state.nameValid} maxLength="35"
                                                   disabled={!this.props.showStepper}/>
                                    </div>
                                </div>
                            </div>
