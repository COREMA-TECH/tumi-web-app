            ...
            <div className="general-information-tab">
                ...
                {window.location.pathname === '/home/company/edit' ? (
                    <div className="options-company">
                        <button className="edit-company-button" onClick={this.props.toggleStepper}>
                ...
                <div className="general-information__content">
                                ...
                                <Query query={this.getStatesQuery} variables={{parent: 6}}>
                                    {({loading, error, data, refetch, networkStatus}) => {
                                        ...
                                        if (data.getcatalogitem != null && data.getcatalogitem.length > 0) {
                                            ...
                                            return (
                                                <SelectForm data={data.getcatalogitem} update={() => {
                            ...
                            <div className="card-form-row">
                                ...
                                <Query query={this.getCitiesQuery} variables={{parent: 140}}>
                                    {({loading, error, data, refetch, networkStatus}) => {
                                        ...
                                        if (data.getcatalogitem != null && data.getcatalogitem.length > 0) {
                                            console.log('Data of cities' + data.getcatalogitem);
                                            return (<SelectForm data={data.getcatalogitem} update={() => {
                    ...
                    <div className="card-form-company card-form-overflow">
                                ...
                                {({loading, error, data, refetch}) => {
                                    ...
                                    if (data.getbusinesscompanies != null && data.getbusinesscompanies.length > 0) {
                                        return data.getbusinesscompanies.map((item) => (
                                            <div className="table-elements">
                                                <div title="Watch Property" className="table__item" onClick={
                                                    this.handleClickOpen('paper', true, item.Id)
                                                }>
                                                    <li>{item.Code}</li>
                                                    <li>{item.Name}</li>
                                                </div>
                        ...
                        <div className="card-form-footer">
							<span className="add-property" onClick={
                                this.handleClickOpen('paper', false, 0)
							}>
								+ Add Property
							</span>
                        </div>
