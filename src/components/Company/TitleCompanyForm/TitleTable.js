				...
				<Table className={classes.table}>
					<TableHead>
						<TableRow>
							...
							<CustomTableCell className={"company-th Table-head"}>Title Code</CustomTableCell>
							<CustomTableCell className={"company-th Table-head"}>Title Name</CustomTableCell>
						</TableRow>
					</TableHead>
					<TableBody>
...
export default withStyles(styles)(TitleTable);
