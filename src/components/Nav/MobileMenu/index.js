				...
				<ul className="MainMenu-container">
					...
					{items.map(item => {
						return item.Forms.Value == "/home/Properties" ?
							<li className="MainMenu-option">
								<Link to={`/home/Properties`} className="MenuMobile-link" onClick={this.props.handleCloseMenu}>
					...
					{items.map(item => {
						return item.Forms.Value == "/home/Contracts" ?
							<li className="MainMenu-option">
								<Link to={`/home/Contracts`} className="MenuMobile-link" onClick={this.props.handleCloseMenu}>
					...
					{items.map(item => {
						return item.Forms.Value == "/home/employees" ?
							<li className="MainMenu-option">
								<Link to={`/home/employees`} className="MenuMobile-link" onClick={this.props.handleCloseMenu}>
