...
class RolesTable extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
				<div className="card p-3 tumi-forcedResponsiveTable">
					<Table className={classes.table}>
						<TableHead>
							<TableRow>
								<CustomTableCell className={"Table-head"} style={{ width: '150px' }}>Actions</CustomTableCell>
								<CustomTableCell className={"Table-head"}>Company</CustomTableCell>
								<CustomTableCell className={"Table-head"}>Description</CustomTableCell>
								<CustomTableCell className={"Table-head"}>Home Page</CustomTableCell>
								<CustomTableCell className={"Table-head"}>Regions</CustomTableCell>
							</TableRow>
						</TableHead>
						<TableBody>
...
// 												select
// 												name="company"
// 												value={row.Id_Company}
// 												margin="normal"
// 												disabled
// 											>
// 												{this.props.company.map(({ Id, Name }) => (
