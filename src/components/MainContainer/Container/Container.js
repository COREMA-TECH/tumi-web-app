	...
	render() {
		...
		return (
			<div className="container-fluid">
				...
				<Route exact path="/home/active-report-consolidated" component={EmployeesProperties} />	
				<Route exact path="/home/active-report" component={EmployeesPropertiesConsolidated} />		
