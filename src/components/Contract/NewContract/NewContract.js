...
class NewContract extends Component {
	...
	insertContract = () => {
		...
		this.props.client
			...
			.catch((err) => {
				this.props.handleOpenSnackbar('warning', 'Complete all the inputs and try again');
				console.log(err);
			});
	};
								...
								<div className="contract-body-row__form">
									<div className="card-form-body">
										...
										<div className="card-form-row">
											...
											<InputForm value={this.state.User_Signed_Title} change={(text) => {}} />
										</div>
										<div className="card-form-row">
...
export default withApollo(withGlobalContent(NewContract));
