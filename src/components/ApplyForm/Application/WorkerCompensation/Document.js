...
const Document = (data = {}) => {
    const { signature, date, applicantName, applicantAddress, applicantCity, applicantState,
        applicantZipCode, injuryDate, initialProgram, initialNotification, injuryNotification, languageForm
     } = data;
    ...
    const spanishVer = `
        ...
        <p style="text-align: center; font-family: 'Times New Roman';"><span style="font-family: Times New Roman;"><b>Confirmación del Empleado de la Red de Compensación para Trabajadores </b></span></p>
        <p style="text-align: justify; font-family: Times New Roman;"><strong><span style="font-family: 'Times New Roman';">&nbsp;</span></strong></p>
        <p style="text-align: justify; line-height: 1.5; font-family: Times New Roman;">He recibido la información que me informa cómo obtener atención médica bajo el seguro de compensación para trabajadores de mi empleador. </p>
        <p style="text-align: justify; font-family: Times New Roman;"><span style="font-size: 11.5pt;">&nbsp;</span></p>
        <p style="text-align: justify; font-family: Times New Roman;">Si sufro una lesión en el trabajo y vivo en un área de servicios descrita en esta información, comprendo que:</p>
        <ol style="margin-top: 0in; margin-bottom: .0001pt; margin-left: 20px;">
            <li style="text-align: justify; line-height: 1.5; font-family: Times New Roman;">Debo elegir un médico de tratamiento de la lista de médicos de la red. O podría solicitarle a mi médico de cabecera de la OMS que acepte atenderme como médico de tratamiento. Si elijo a mi médico de cabecera como a mi médico del tratamiento, llamaré a Texas Mutual al (800) 8595995 para notificarles mi opción.</li>
            <li style="text-align: justify; line-height: 1.5; font-family: Times New Roman;">Debo dirigirme a mi médico de tratamiento para todos los servicios de atención médica relacionados con mi lesión. Si necesito un especialista, mi médico de tratamiento me dará la derivación. Si necesito atención de emergencia podré dirigirme a cualquier lugar.</li>
            <li style="text-align: justify; font-family: Times New Roman;">La compañía de seguros abonará los costos del médico de tratamiento y de los otros proveedores de la red. </li>
            <li style="text-align: justify; line-height: 1.5; font-family: Times New Roman;">Podría tener que abonar la factura si recibo asistencia médica en cualquier otro lugar que no sea un médico de la red, si no cuento con la aprobación de la red.</li>
            <li style="text-align: justify; line-height: 1.5; font-family: Times New Roman;">A sabiendas hacer un reclamo falso de compensación puede dar lugar a una investigación penal que podría resultar en sanciones penales, como multas y encarcelamiento.</li>
        </ol>
        <p style="text-align: justify; font-family: Times New Roman;"><span style="">&nbsp;</span></p>
        <table style="border-collapse: collapse; width: 100%; border-style: none; margin-bottom: 14px" border="0" cellspacing="5">
            <tbody>
                ...
                <tr>
                    <td style="width: 40%; font-size: 10px; vertical-align: top;">Firma</td>
                    <td style="width: 20%; font-size: 10px; vertical-align: top;">Fecha</td>
                    <td style="width: 40%; font-size: 10px; vertical-align: top;">Aclaración</td>
                </tr>
            </tbody>
        </table>
        <table style="border-collapse: collapse; width: 100%; border-style: none; margin-bottom: 14px" border="0">
            <tbody>
                <tr>
                    <td style="width: 10%; margin-left: 5px;">Vivo en:</td>
                    <td style="width: 90%; border-bottom: 1px solid black; margin-right: 5px;">${applicantAddress || ''}</td>
                </tr>
                <tr>
                    <td style="width: 20%; margin-left: 5px;">&nbsp;</td>
                    <td style="width: 80%; margin-right: 5px; font-size: 10px; vertical-align: top;">Dirección</td>
                </tr>
            </tbody>
        </table>
        <table style="border-collapse: collapse; width: 100%; border-style: none; margin-bottom: 14px" border="0">
            <tbody>
                ...
                <tr>
                    <td style="width: 20%; margin-left: 5px;">&nbsp;</td>
                    <td style="width: 20%; margin-right: 5px; font-size: 10px; vertical-align: top;">Ciudad</td>
                    <td style="width: 40%; margin-right: 5px; font-size: 10px; vertical-align: top;">Estado</td>
                    <td style="width: 20%; margin-right: 5px; font-size: 10px; vertical-align: top;">Código Postal</td>
                </tr>
            </tbody>
        </table>
        
        <p style="text-align: justify; font-family: Times New Roman;">Nombre del Empleador: <u>TUMI STAFFING INC.</u></p>
        <p style="text-align: justify; font-family: Times New Roman;">Nombre de la Red: <strong>WorkWell, TX</strong></p>
        <p style="text-align: justify; font-family: Times New Roman;"><span style="">&nbsp;</span></p>
        <table style="border-collapse: collapse; width: 100%;" border="1">
            <tbody>
                <tr>
                    <td style="width: 100%; padding: 8px;">
                        ...
                        <p style="font-family: Times New Roman;"><span style="">Todos los empleados deben firmar este formulario al inicio del programa o dentro de los 3 días después de ser contratados, y al momento en que se produzca una lesión. Sírvase para indicar en qué momento se firmó esta confirmación:</span></p>
                        <ul style="margin-top: 1.0pt; margin-bottom: .0001pt; list-style: none;">
                            <li style="margin: 1pt 0in 0.0001pt 31.2px; font-family: Times New Roman;"><span style="">${initialProgram ? '&#10003;': '&#9633;'} Inicio del programa de la red (en toda la compañía)</span></li>
                            <li style="margin: 1pt 0in 0.0001pt 31.2px; font-family: Times New Roman;"><span style="">${initialNotification ? '&#10003;': '&#9633;'} Notificación inicial al empleado (nuevo)</span></li>
                            <li style="margin: 0.95pt 0in 0.0001pt 31.2px; font-family: Times New Roman;"><span style="">${injuryNotification ? '&#10003;': '&#9633;'} Notificación de la lesión: <u>(Fecha de la lesión: ${injuryDate})</u></span></li>
                        </ul>
                        <br>
                        <p style="font-family: Times New Roman;"><span style="text-decoration: underline">Conserve este formulario completo en el legajo de personal del empleado. Texas Mutual podría solicitarlo</span></p>
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    return languageForm === "en" ? englishVer : spanishVer;
}
