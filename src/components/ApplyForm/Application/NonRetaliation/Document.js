...
class Document extends Component {
    ...
    handleSignature = (value) => {
        this.setState(_ => ({
            ...
            this.props.createStatesFields(this.state.signature, this.props.applicantName);
        });
    }

    componentWillReceiveProps(nextProps) {
        if (nextProps.signature != this.props.signature) {
            this.setState(_ => {
            ...
            <Fragment>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style={{width: '84.216%'}} colSpan={2}>{this.props.applicantName}</td>
                    </tr>
                    <tr>
