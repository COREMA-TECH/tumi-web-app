                        ...
                        <div className="applicant-card">
                            ...
                            <div className="SummaryTab">
                                ...
                                <div id="DocumentPDF" className="signature-information">
                                    ...
                                    ' width='140' height='140' style='margin-bottom: 0px;'/></td>
                                    
                                    <td style='width: 91.7833%; height: 75px;' valign="bottom">
                                    
                                    <p><strong><span style="font-family: 'times new roman', times; color: #b40639; font-size:24px">SUMMARY</span></strong> <br/>
                                    <span style="font-family: 'times new roman', times; font-size:24px"><span style='color: #b40639;'><strong>NAME</strong>: </span>` + this.state.applicantName + `</span></p>
