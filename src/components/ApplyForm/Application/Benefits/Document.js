                ...
                <div className="row pdf-container" id="benefitsDoc" style={{ maxWidth: '100%' }}>
                    <div id="DocumentPDF" className="signature-information">
                        ...
                        <table style={{borderCollapse: 'collapse', width: '100%', height: 32}} border={1}>
                            ...
                            <tr style={{height: 10}}>
                                <td style={{width: '50.2336%', height: 10}}>
                                    ...
                                    <input style={{borderBottom: "none", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.name || ""}/>
                                </td>
                                <td style={{width: '16.7056%', height: 10}}>
                                    <label  className="BenefitsDoc-label" style={{display: "block", fontSize: "10px", paddingLeft: "5px", paddingRight: "5px", textTransform: "capitalize"}}>
                                        Social Security Number
                                    </label>
                                    <input style={{borderBottom: "none", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.ssn  || ""}/>
                                </td>
                                ...
                                <td style={{width: '17.6402%', height: 10}}>
                                    ...
                                    <input style={{borderBottom: "none", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.effectiveDate || ""}/>
                                </td>
                            </tr>
                            <tr style={{height: 22}}>
                                <td style={{width: '50.2336%', height: 10}}>
                                    ...
                                    <input style={{borderBottom: "none", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.address || ""}/>
                                </td>
                                <td style={{width: '16.7056%', height: 10}}>
                                    <label  className="BenefitsDoc-label" style={{display: "block", fontSize: "10px", paddingLeft: "5px", paddingRight: "5px", textTransform: "capitalize"}}>
                                        Date of Birth
                                    </label>
                                    <input style={{borderBottom: "none", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.birthday || ""}/>
                                </td>
                                <td style={{width: '16.8224%', height: 10}}>
                                    <label  className="BenefitsDoc-label" style={{display: "block", fontSize: "10px", paddingLeft: "5px", paddingRight: "5px", textTransform: "capitalize"}}>
                                        Gender
                                ...
                                <td style={{width: '17.6402%', height: 10}}>
                                    ...
                                    <input style={{borderBottom: "none", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.location || ""}/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        <table style={{borderCollapse: 'collapse', width: '100%'}} border={1}>
                            <tbody>
                            <tr>
                                <td style={{width: '28.9331%'}}>
                                    <label  className="BenefitsDoc-label" style={{display: "block", fontSize: "10px", paddingLeft: "5px", paddingRight: "5px", textTransform: "capitalize"}}>
                                        City                                        
                                    </label>
                                    <input style={{borderBottom: "none", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.city || ""}/>
                                </td>
                                <td style={{width: '7.90505%'}}>
                                    <label  className="BenefitsDoc-label" style={{display: "block", fontSize: "10px", paddingLeft: "5px", paddingRight: "5px", textTransform: "capitalize"}}>
                                        State                                        
                                    </label>
                                    <input style={{borderBottom: "none", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.state || ""}/>
                                </td>
                                <td style={{width: '13.5125%'}}>
                                    <label  className="BenefitsDoc-label" style={{display: "block", fontSize: "10px", paddingLeft: "5px", paddingRight: "5px", textTransform: "capitalize"}}>
                                        Zip Code                                        
                                    </label>
                                    <input style={{borderBottom: "none", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.zipcode || ""}/>
                                </td>
                                <td style={{width: '16.5498%'}}>
                                    <label  className="BenefitsDoc-label" style={{display: "block", fontSize: "10px", paddingLeft: "5px", paddingRight: "5px", textTransform: "capitalize"}}>
                                        Full-Time Date of Hire                                        
                                    </label>
                                    <input style={{borderBottom: "none", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.hiredate || ""}/>
                                </td>
                                <td style={{width: '16.9004%'}}>
                                    <label  className="BenefitsDoc-label" style={{display: "block", fontSize: "10px", paddingLeft: "5px", paddingRight: "5px", textTransform: "capitalize"}}>
                                        Home Phone number                                        
                                    </label>
                                    <input style={{borderBottom: "none", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.homePhone || ""}/>
                                </td>
                                <td style={{width: '16.1994%'}}>
                                    <label  className="BenefitsDoc-label" style={{display: "block", fontSize: "10px", paddingLeft: "5px", paddingRight: "5px", textTransform: "capitalize"}}>
                                        Phone Number                                        
                                    </label>
                                    <input style={{borderBottom: "none", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.workPhone || ""}/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <table style={{borderCollapse: 'collapse', width: '100%'}} border={1}>
                            ...
                            <tr>
                                ...
                                <td style={{width: '28.804%'}}><span>Decilne (I choose NOT to participate) Reason:</span><input style={{borderBottom: "1px solid black", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.hmoReason  || ""}/></td>
                            </tr>
                            <tr>
                                ...
                                <td style={{width: '28.804%'}}><span>Decilne (I choose NOT to participate) Reason:</span><input style={{borderBottom: "1px solid black", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.ooaReason || ""}/></td>
                            </tr>
                            </tbody>
                        </table>
                                ...
                                props.dependents ? (props.dependents.map(item => {
                                    return (
                                        <tr>
                                            ...
                                            <td style={{width: '16.6667%'}}>
                                                <input type="text" disabled={true}  value={item.dependent_name || ""} id=""/>
                                            </td>
                                            <td style={{width: '16.6667%'}}>
                                                <input type="text" disabled={true}  value={item.dependent_dob || ""} id=""/>                                                
                                            </td>
                                            ...
                                            <td style={{width: '20.9575%'}}>
                                                <input type="text" disabled={true}  value={item.relationship || ""} id=""/>                                                                                                
                                            </td>
                        ...
                        <div style={{padding: "10px 5px", borderLeft: "1px solid black", borderRight: "1px solid black"}}>
                            ...
                            <p><label style={{ fontSize: "18px" }} dangerouslySetInnerHTML={{ __html: `${!props.preTax ? '&#10003;' : '&#9633;'}`}} /> Post-Tax: I elect to pay for my eligible premiums on an after-tax basis outside of this Plan, and I authorize appropriate after-tax payroll deductions.</p>
                        </div>                        
                        ...
                        <table style={{borderCollapse: 'collapse', width: '100%'}} border={1}>
                            ...
                            <tr>
                                ...
                                <td style={{width: '50%'}}>
                                    ...
                                    <input style={{borderBottom: "none", width: "100%", paddingLeft: "5px"}} type="text" disabled={true}  value={props.date || ""}/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
