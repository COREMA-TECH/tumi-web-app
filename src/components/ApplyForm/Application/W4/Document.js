 ...
 * @param {function} props.languageForm handle language
 ...
 * @param {*} props.data.address
 * @param {*} props.data.estadoCivil
 * @param {*} props.data.estadoCivil1
 * @param {*} props.data.estadoCivil2
 * @param {*} props.data.postalCode
 * @param {*} props.data.socialSecurityExtention
 * @param {*} props.data.excention
 * @param {*} props.data.payCheck
 * @param {*} props.data.excentionYear
                                ...
                                <tr style={{ height: '34px' }}>
                                    ...
                                    <td style={{
                                        ...
                                        <input
                                                    ...
                                                    checked={socialSecurityExtention}
                                                    onClick={(e) => {
                                                ...
                                                <label style={{ fontSize: "18px", paddingLeft: "5px" }} htmlFor="socialSecurityExtention"
                                                    dangerouslySetInnerHTML={{
                                                        __html: `${socialSecurityExtention ? '&#10003;' : '&#9633;'}`
                                                    }}
                                                />
                                            </strong></div>
                                    </td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <span style={{ fontWeight: '900' }}>Employee’s signature</span>
                                        (This form is not valid unless you sign it).  ▶  <img src={signature}
                                            style={{
                                                width: '100px',
                                                height: '30px',
                                                display: 'inline-block',
